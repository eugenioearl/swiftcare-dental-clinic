...
import { User, Mail, Phone, UserCheck, Edit2, Save, X } from 'lucide-react'
...
export default function StaffProfile() {
  ...
  const [formData, setFormData] = useState({
    ...
    bio: 'Dedicated staff member providing excellent patient support and administrative services.'
  })
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">Manage your staff profile</p>
          </div>
        </div>
